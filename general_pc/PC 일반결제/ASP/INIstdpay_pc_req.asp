                ...
                <div class="card">
                    ...
                    <form name="" id="SendPayForm_id" method="post" class="mt-5">
                        <div class="row g-3 justify-content-between" style="--bs-gutter-x:0rem;">
                            ...
                            <label class="col-10 col-sm-9 input">
                                <input type="text" name="mid" value="<%=maid%>">
                            </label>
							...
							<label class="col-10 col-sm-2 input param" style="border:none;">use_chkfake</label>
                            <label class="col-10 col-sm-9 input">
                                <input type="text" name="use_chkfake" value="Y">
                            </label>
							...
							<label class="col-10 col-sm-2 input param" style="border:none;">verification</label>
                            <label class="col-10 col-sm-9 input">
                            ...
                            <label class="col-10 col-sm-9 input">
                                <input type="text" name="mKey" value="<%=mKey%>">
                            </label>
				    		...
				    		<input type="hidden" name="returnUrl" value="http://{가맹점도메인}/INIstdpay_pc_return.asp">
                            <input type="hidden" name="closeUrl" value="http://{가맹점도메인}/close.asp">
